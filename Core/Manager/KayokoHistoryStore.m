...
- (NSArray<NSString *> *)availableSearchAppBundleIdentifiersWithError:(NSError **)error {
    return [self availableSearchAppBundleIdentifiersForHistoryKey:nil error:error];
}

- (NSArray<NSString *> *)availableSearchAppBundleIdentifiersForHistoryKey:(NSString *)historyKey
                                                                      error:(NSError **)error {
    sqlite3_stmt *statement = NULL;
